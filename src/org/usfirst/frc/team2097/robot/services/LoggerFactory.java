package frc.team2097.services.logger;
...
public class LoggerFactory
{
    ...
    public static Logger createNewLogger(Class aClass) { return createNewLogger(aClass, Level.INFO); }

    public static Logger createNewLogger(Class aClass, Level level) {
